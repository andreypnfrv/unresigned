...
function useCoreReadingCollections(): CoreReadingCollection[] {
  ...
  return useMemo(() => [
    {
      ...
      summary: `<div>
        <p>
          ...
          For two years Eliezer Yudkowsky wrote a blogpost a day, braindumping thoughts on rationality, ambition and artificial intelligence. Those posts were edited into this introductory collection, recommended reading for ${siteName} readers.
        </p>
      </div>`,
    ...
    },
    {
      ...
      userId: "nmk3nLpQE89dMRzzN",
      summary: `<div>
        <p>${siteName} can be kind of intimidating - there's a lot of concepts to learn. We recommend getting started with the Highlights, a collection of 50 top posts from Eliezer's Sequences.</p>
    ...
    {
      title: `Best of ${siteName}`,
      id: "dummyId5",
      userId: "nmk3nLpQE89dMRzzN",
      summary: `<div>Each December, the ${siteName} community reviews the best posts from the previous year, and votes on which ones have stood the tests of time.</div>`,
...
const LWCoreReading = ({minimal}: {
  ...
  const coreReadingCollections = useCoreReadingCollections();

  return <SingleColumnSection className={classes.root}>
    {coreReadingCollections.map(collection => <CollectionsItem key={collection.title} collection={collection}/>)}
  </SingleColumnSection>
}
