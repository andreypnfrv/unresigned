      ...
      <div className={classes.topSectionsContainer}>
        <div>
          <div className={classes.essay}>
            ...
            <p>Unresigned is trying to cultivate a specific culture. The best pointers towards that culture are the <Link to="/rationality">Unresigned Sequences</Link> and the <Link to="/posts/LbbrnRvc9QwjJeics/new-user-s-guide-to-lesswrong">New User Guide</Link>.</p>
            <p>Unresigned operates under benevolent dictatorship of the Lightcone Infrastructure team, under its current CEO <Link to="/users/habryka4">habryka</Link>. It is not a democracy. For some insight into our moderation philosophy see <Link to="/posts/tscc3e5eujrsEeFN4/well-kept-gardens-die-by-pacifism">"Well Kept Gardens Die By Pacifism"</Link>.</p>
            ...
            <p>Unresigned relies heavily on rate-limits in addition to deleting content and banning users. New users start out with some relatively lax rate limits to avoid spamming. Users who get downvoted acquire stricter and stricter rate limits the more they get downvoted.</p>
            <p>Not all moderation on Unresigned is done by the moderators. Authors with enough upvoted content on the site can moderate their own posts.</p>
